-- Create langextract_ prefixed tables for document processing
...
SELECT table_name FROM information_schema.tables WHERE table_name LIKE 'langextract_%' ORDER BY table_name;
