-- Reset Embeddings Feature - Complete Cleanup and Re-initialization
-- This script removes all embeddings-related objects and recreates them fresh
...
-- Show final status
SELECT 
    'Embeddings feature reset completed successfully!' as message,
    NOW() as completed_at;
